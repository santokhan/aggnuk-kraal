...
<template>
    <QContainer>
        <QHeader>
            ...
            <QTitle>At what maximum age do you wish to retire?</QTitle>
            <QSubTitle></QSubTitle>
        </QHeader>
        <QMain>
            <QInputButtonSquare :value="'65'" :setData="setData" :active="active('65')">
            </QInputButtonSquare>
            <QInputButtonSquare :value="'67'" :setData="setData" :active="active('67')">
            </QInputButtonSquare>
            <QInputButtonSquare :value="'70'" :setData="setData" :active="active('70')">
            </QInputButtonSquare>
            <QInputButtonSquare :value="'75+'" :setData="setData" :active="active('75+')">
            </QInputButtonSquare>
        </QMain>
        <QFooter>
